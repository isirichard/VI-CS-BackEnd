...
public class FrmBloqueoCliente extends JFrame {
	...
	public FrmBloqueoCliente() {
		...
		jpDatosCliente.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Datos Cliente", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
