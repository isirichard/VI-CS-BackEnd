...
public class FrmRegistroVenta extends JFrame{
	...
	private JLabel lblTipoDOC,lblNro,lblCliente,lblDireccionCli,lblEmpresa,lblRUC,lblDireccionEmp,lblTelefono,lblEmpresaNom,lblRUCNom,lblDireccionNom,lblTelefonoNom,
	...
	private JTextField txtNro,txtCliente,txtDireccion,txtSKU,txtProducto,txtCodigoVend,txtCantidad,txtPrecioUnitario,txtPrecioxCant,txtPrecioVenta,
	txtIGV,txtPrecioTotal;
	private JComboBox JCTipoDOC,JCPago;
	private JDateChooser JDEmision,JDPago;
	private JRadioButton JREntregado,JRNoEntregado;
...
//		setIconifiable(true);
		...
		lblCliente.setBounds(10, 57, 46, 14);
		JPDatosCliente.add(lblCliente);
		
		lblDireccionCli = new JLabel("Direccion");
		lblDireccionCli.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblDireccionCli.setBounds(10, 90, 46, 14);
		JPDatosCliente.add(lblDireccionCli);
		...
		txtCliente.setBounds(66, 53, 265, 22);
		...
		JREntregado.setFont(new Font("Tahoma", Font.PLAIN, 11));
		JREntregado.setBounds(16, 21, 109, 23);
		JPEntrega.add(JREntregado);
		
		JRNoEntregado = new JRadioButton("No entregado");
		JRNoEntregado.setFont(new Font("Tahoma", Font.PLAIN, 11));
		JRNoEntregado.setBounds(16, 47, 109, 23);
		JPEntrega.add(JRNoEntregado);
