...
//	private LogicaButtons logica;
	private FrmBusquedaCliente busqueda;
//	private Cliente cliente;
	private JButton btninvisible;
	int codigo;
	
	private static FrmServicioCliente instancia;
	private FrmServicioCliente() {
//		logica=new LogicaButtons();
		busqueda=FrmBusquedaCliente.Iniciar();
...
//		cliente= new Cliente();
		...
		txtDocumento.setFont(new Font("Tahoma", Font.BOLD, 11));
...
//				logica.obtenerDatosCliente(cliente, busqueda.getCodigo());
//				logica.btnBuscar(e);
		...
		busqueda.getTabla().addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				...
				if(e.getClickCount()==2) {
					codigo=(Integer.parseInt(busqueda.getTabla().getValueAt(busqueda.getTabla().getSelectedRow(), 0).toString()));
//					logica.obtenerDatosCliente(cliente, codigo);
					
					actualizar();
					limpiarBusqueda(busqueda);
					busqueda.dispose();
...
//			txtTipoDoc.setText(cliente.getTipDocCod().getDescripcion());
//			txtNombres.setText(cliente.getPerNom());
//			txtCelular.setText(cliente.getPerCel());
//			txtTelefono.setText(cliente.getPerTel());
//			txtDocumento.setText(cliente.getPerNro());
//			JTADireccion.setText(cliente.getPerDir());
//			lblEstadoCliente.setText(cliente.getEstCod().getDescripcion());
////			lblEstadoCliente.setText("Ddd");
//			System.out.println(cliente.getPerNom());
			
		
	}
	
	public static FrmServicioCliente Iniciar() {
		if(instancia==null) {
			instancia=new FrmServicioCliente();
		}
		return instancia;
	...
	public void setTxtNombre(String s) {
...
//	}
	...
	public void limpiarBusqueda(FrmBusquedaCliente b) {
		b.txtNro.setText("");
		b.txtCliente.setText("");
		b.jcTipoDoc.setSelectedIndex(0);
//		b.getTabla().setModel(logica.mostrarTablaBuscarCliente(b.txtNro.getText(),b.txtCliente.getText(),b.jcTipoDoc.getSelectedIndex()));
